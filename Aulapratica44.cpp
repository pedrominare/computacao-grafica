...
GLint nVerts = 4;
wcPt2D verts [4] = {{50.0,125.0}, {191.42,125.0}, {50.0,54.28},{191.42,195.71}};
...
square(verts); // Exibe triângulo transformado
glFlush();
}
